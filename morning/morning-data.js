const morningDuaas = [
  {
    label: "O Allah, You are my Lord; none has the right to be worshipped except You...ok ",
    count: "1x",
...
8. For indeed, none forgives sins except You.`,
  ...
  {
    label: "We have entered the morning, and sovereignty has entered the morning belonging to Allah alone.",
    count: "1x",
...
وَأَعُوذُ بِكَ مِنْ عَذَابٍ فِي النَّارِ
وَعَذَابٍ فِي الْقَبْرِ`,
    transliteration: `1. Asbahna wa asbahal-mulku lillah
2. Walhamdu lillah
3. La ilaha illallahu wahdahu la sharika lah
4. Lahul-mulku wa lahul-hamd
5. Wa huwa 'ala kulli shay'in qadir
6. Rabbi as'aluka khayra ma fi hadhal-yawmi wa khayra ma ba'dahu
7. Wa a'udhu bika min sharri ma fi hadhal-yawmi wa sharri ma ba'dahu
8. Rabbi a'udhu bika minal-kasali wa su'il-kibar
9. Wa a'udhu bika min 'adhabin fin-nar
10. Wa 'adhabin fil-qabr`,
    translation: `1. We have entered the morning, and sovereignty has entered the morning belonging to Allah alone.
...
6. My Lord, I ask You for the good that is in this day and the good that comes after it.
7. And I seek refuge in You from the evil that is in this day and the evil that comes after it.
8. My Lord, I seek refuge in You from laziness and decrepit old age.
9. And I seek refuge in You from punishment in the Fire.
10. And from punishment in the grave.`,
  ...
  {
    label: "I declare Allah free of all imperfections, and all praise is for Him.",
    count: "3x",
...
وَمِدَادَ كَلِمَاتِهِ`,
    transliteration: `1. Subhanallahi wa bihamdihi
2. 'Adada khalqihi
3. Wa rida nafsihi
4. Wa zinata 'arshihi
5. Wa midada kalimatihi`,
    translation: `1. I declare Allah free of all imperfections, and all praise is for Him.
2. As much as the number of His creation.
3. As much as He Himself is pleased with.
4. As much as the weight of His Throne.
...
Recite Sūrah an-Nās - 3x`,
  ...
  {
    label: "O Allah, by Your aid we enter the morning.",
    count: "1x",
...
وَإِلَيْكَ النُّشُورُ`,
    transliteration: `1. Allahumma bika asbahna
2. Wa bika amsayna
3. Wa bika nahya
4. Wa bika namut
5. Wa ilaykan-nushur`,
    translation: `1. O Allah, by Your aid we enter the morning.
2. And by Your aid we enter the evening.
